...
def EdgeGen(noVer,S,C,w_s,w_c,validIV,prev_sol_start,condset):
    ...
    collider_triple_initial,noncollider_triple_initial, col_noncol_triple_initial,no_edge,col_orient,noncol_orient,connected_orient,connected_pairs = generate_triples(noVer, S, C)
    ...
    for t_e in [[0,-1,1],[1,-1,4],[1,-2,4],[1,-3,4]]:
        if t_e not in edges:
    ...
    path_con_lim,path_edge_lim,path_length_lim,path_IV_violater = con_edge_disc_lim(D_est,E_est, dum_verts, noVer,maxlength,condset) 
    ...
    while it_no<2:
        ...
        if new_edges == []:
            ...
            if maxlength==noVer-1:
                ...
                collider_triple,noncollider_triple, col_noncol_triple,no_edge,col_orient,noncol_orient,connected_orient,connected_pairs = generate_triples(noVer, S, C)
                col_orient, noncol_orient, connected_orient = update_triple_orientation(collider_triple_initial, noncollider_triple_initial, col_noncol_triple_initial, col_orient, noncol_orient, connected_orient,edges)
                col_not, noncol_not,col_noncol_not = update_triples(C_not_yet_satisfied_o, collider_triple_initial, noncollider_triple_initial, col_noncol_triple_initial, col_orient, noncol_orient, connected_orient)
        ...
        path_con_lim,path_edge_lim,path_length_lim,path_IV_violater = con_edge_disc_lim(D_est_int_all,E_est_int_all, dum_verts_int_all, noVer,maxlength,condset)    
