...
# -*- coding: utf-8 -*-
"""
Update S(z) and \bar{S}(z) without considering errors
"""
...
def update_triples_random(C_not, collider_triple, noncollider_triple, col_noncol_triple, col_orient, noncol_orient, connected_orient):
