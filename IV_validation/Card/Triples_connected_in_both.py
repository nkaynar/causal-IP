...
def generate_triples(noVer, S, C):
    ...
    tic_tottot =   timeit.default_timer()  
  
    return(collider_triple,noncollider_triple, col_noncol_triple,no_edge,col_orient,noncol_orient,connected_orient,connected_pairs)