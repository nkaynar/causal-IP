...
"""
Get conditional independence/dependence relations

"""

import json
import os
save_dir = '/home/umit/Documents/Nur_data'
import subprocess
import pandas as pd
import pdb
...
def conflicted_indep(noVer):
    ...
    if noVer<15:
        with open('../ASP/hyttinen2014uai_ver6/pkg/R/export.JSON') as f:
            data = json.load(f)
    else:
        with open('../ASP_conflict_IP/hyttinen2014uai_ver6/pkg/R/export.JSON') as f:
            data = json.load(f)
