learn<-function(   D, #data
  ...
  if (encode=="old_sat.pl"){
  
  
  if ( is.na(p) ) p<-0.5
  
  #this is a global list holding the indeps.
  if (encode=="old_sat.pl"){global_indeps<<-list()}
  ...
  system(paste("./../ASP/clingo_5n4_linux", # clingo_5n4_linux clingo430 clingo_v522_linux
               clingoconf,
