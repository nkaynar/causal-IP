...
setwd("~/Documents/Nur/paper_computationalTest_MSrevision/paper codes/limited length unconflicted/Oracle setting/ASP_run_newASP/hyttinen2014uai_ver6/pkg/R")
source('load.R')
loud()
